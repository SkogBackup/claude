...
title: fast-mode
type: note
permalink: claude/docs/claude-code/fast-mode
---
...
1. The `↯` icon turns gray to indicate cooldown
1. You continue working at standard speed and pricing
1. When the cooldown expires, fast mode automatically re-enables
