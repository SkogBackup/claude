...
title: analytics
type: note
permalink: claude/docs/claude-code/analytics
---
...
1. Claude Code sessions that edited matching files within a time window are identified
1. PR lines are matched against Claude Code output using multiple strategies
1. Metrics are calculated for AI-assisted lines and total lines
