...
type: note
permalink: claude/docs/claude-code/common-workflows
---
...
- Request a glossary of project-specific terms </Tip>
...
- Install a [code intelligence plugin](/en/discover-plugins#code-intelligence) for your language to give Claude precise "go to definition" and "find references" navigation </Tip>
...
- Let Claude know if the error is intermittent or consistent </Tip>
...
- Do refactoring in small, testable increments </Tip>
...
- Check the [subagents documentation](/en/sub-agents) for detailed examples </Tip>
...
- Request documentation for public APIs, interfaces, and complex logic </Tip>
...
- When Claude references images (for example, `[Image #1]`), `Cmd+Click` (Mac) or `Ctrl+Click` (Windows/Linux) the link to open the image in your default viewer </Tip>
...
- You can reference multiple files in a single message (for example, "@file1.js and @file2.js") </Tip>
...
1. **Context Restoration**: The conversation resumes with all previous context intact </Tip>
...
- Consider creating multiple scripts for different types of verification </Tip>
...
- Consider using `--output-format` for structured output </Tip>
...
- Use `--output-format stream-json` for real-time output of each conversation turn </Tip>
...
- Claude can explain complex features like MCP integration, enterprise configurations, and advanced workflows </Tip>
