...
type: note
permalink: claude/docs/claude-code/amazon-bedrock
---
...
1. Select an Anthropic model from the **Model catalog**
1. Complete the use case form. Access is granted immediately after submission.
