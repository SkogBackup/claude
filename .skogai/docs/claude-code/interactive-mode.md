...
type: note
permalink: claude/docs/claude-code/interactive-mode
---
...
See [Terminal configuration](/en/terminal-config) for details. </Note>
...
1. **Type query**: enter text to search for in previous commands. The search term is highlighted in matching results
1. **Navigate matches**: press `Ctrl+R` again to cycle through older matches
1. **Accept match**:
