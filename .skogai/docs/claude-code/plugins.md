...
title: plugins
type: note
permalink: claude/docs/claude-code/plugins
---
...
1. **Test components individually**: Check each skill, agent, and hook separately
1. **Use validation and debugging tools**: See [Debugging and development tools](/en/plugins-reference#debugging-and-development-tools) for CLI commands and troubleshooting techniques
...
1. **Version your plugin**: Use [semantic versioning](/en/plugins-reference#version-management) in your `plugin.json`
1. **Create or use a marketplace**: Distribute through [plugin marketplaces](/en/plugin-marketplaces) for installation
1. **Test with others**: Have team members test the plugin before wider distribution
