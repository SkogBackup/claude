...
title: llm-gateway
type: note
permalink: claude/docs/claude-code/llm-gateway
---
...
1. **Bedrock InvokeModel**: `/invoke`, `/invoke-with-response-stream`

   - Must preserve request body fields: `anthropic_beta`, `anthropic_version`

1. **Vertex rawPredict**: `:rawPredict`, `:streamRawPredict`, `/count-tokens:rawPredict`
...
LiteLLM is a third-party proxy service. Anthropic doesn't endorse, maintain, or audit LiteLLM's security or functionality. This guide is provided for informational purposes and may become outdated. Use at your own discretion. </Warning>
