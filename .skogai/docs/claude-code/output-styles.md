...
title: output-styles
type: note
permalink: claude/docs/claude-code/output-styles
---
...
You can save these files at the user level (`~/.claude/output-styles`) or project level (`.claude/output-styles`). [Plugins](/en/plugins-reference) can also ship output styles in an `output-styles/` directory.
