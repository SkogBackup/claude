...
title: jetbrains
type: note
permalink: claude/docs/claude-code/jetbrains
---
...
1. Set the diff tool to `auto` to show diffs in the IDE, or `terminal` to keep them in the terminal
...
1. Configure the Claude command path in plugin settings
1. For WSL users, use the WSL command format mentioned in the configuration section
