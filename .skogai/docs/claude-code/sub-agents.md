...
title: sub-agents
type: note
permalink: claude/docs/claude-code/sub-agents
---
...
1. The subagent definition's `model` frontmatter
...
- **Check into version control:** share project subagents with your team </Tip>
