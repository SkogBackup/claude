...
type: note
permalink: claude/docs/claude-code/terminal-config
---
...
1. Enable "Notification Center Alerts"
1. Click "Filter Alerts" and check "Send escape sequence-generated alerts"
