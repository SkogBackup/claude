...
title: security
type: note
permalink: claude/docs/claude-code/security
---
...
1. Use virtual machines (VMs) to run scripts and make tool calls, especially when interacting with external web services
1. Report suspicious behavior with `/feedback`
...
1. Report it through our [HackerOne program](https://hackerone.com/anthropic-vdp/reports/new?type=team&report_type=vulnerability)
1. Include detailed reproduction steps
1. Allow time for us to address the issue before public disclosure
