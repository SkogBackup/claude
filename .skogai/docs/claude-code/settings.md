...
title: settings
type: note
permalink: claude/docs/claude-code/settings
---
...
1. **Local** - overrides project and user settings
1. **Project** - overrides user settings
1. **User** (lowest) - applies when nothing else specifies the setting
...
1. Team members are then prompted to install plugins from that marketplace
1. Users can skip unwanted marketplaces or plugins (stored in user settings)
1. Installation respects trust boundaries and requires explicit consent
