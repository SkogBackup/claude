...
title: slack
type: note
permalink: claude/docs/claude-code/slack
---
...
1. **Detection**: Claude analyzes your message and detects coding intent
1. **Session creation**: A new Claude Code session is created on claude.ai/code
1. **Progress updates**: Claude posts status updates to your Slack thread as work progresses
1. **Completion**: When finished, Claude @mentions you with a summary and action buttons
1. **Review**: Click "View Session" to see the full transcript, or "Create PR" to open a pull request
...
For Enterprise and Team accounts, sessions created from Claude in Slack are automatically visible to the organization. See [Claude Code on the Web sharing](/en/claude-code-on-the-web#share-sessions) for more details.
...
1. Check that you have Claude Code on the web access enabled
1. Ensure you have at least one GitHub repository connected to Claude Code

### Repository not showing

1. Connect the repository in Claude Code on the web at [claude.ai/code](https://claude.ai/code)
1. Verify your GitHub permissions for that repository
...
1. Include the repository name in your request for more accurate selection

### Authentication errors

1. Disconnect and reconnect your Claude account in the App Home
1. Ensure you're signed into the correct Claude account in your browser
1. Check that your Claude plan includes Claude Code access

### Session expiration

1. Sessions remain accessible in your Claude Code history on the web
1. You can continue or reference past sessions from [claude.ai/code](https://claude.ai/code)
