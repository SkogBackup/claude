...
title: desktop
type: note
permalink: claude/docs/claude-code/desktop
---
...
1. Verify you have an active paid subscription: Pro, Max, Team, or Enterprise.
1. If the CLI works but Desktop does not, quit the desktop app completely, not just close the window, then reopen and sign in again.
...
1. Restart the app.
1. Check for pending updates. The app auto-updates on launch.
1. On Windows, check Event Viewer for crash logs under **Windows Logs → Application**.
