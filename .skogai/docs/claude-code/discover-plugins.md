...
type: note
permalink: claude/docs/claude-code/discover-plugins
---
...
To distribute plugins independently, [create your own marketplace](/en/plugin-marketplaces) and share it with users. </Note>
...
1. Choose a marketplace from the list
1. Select **Enable auto-update** or **Disable auto-update**
...
1. **Restart Claude Code**: After updating, restart your terminal and run `claude` again.
