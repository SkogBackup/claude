...
type: note
permalink: claude/docs/claude-code/google-vertex-ai
---
...
1. Search for "Claude" models
1. Request access to desired Claude models (for example, Claude Sonnet 4.6)
1. Wait for approval (may take 24-48 hours)
