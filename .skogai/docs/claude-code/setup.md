...
title: setup
type: note
permalink: claude/docs/claude-code/setup
---
...
New to the terminal? See the [terminal guide](/en/terminal-guide) for step-by-step instructions. </Tip>
...
Homebrew keeps old versions on disk after upgrades. Run `brew cleanup` periodically to reclaim disk space. </Note>
