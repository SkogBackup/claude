...
2. User: "use placeholders instead of making things up"
3. Claude: tries to read more files to find the answer
4. User: increasingly frustrated ("THE ONLY FUCKING PLACE WHERE THE INFORMATION YOU NEED EXISTS IS BY ASKING THE USER/ME!")
...
Question Type: Design intent, history, rationale
Method: Ask user
────────────────────────────────────────
Question Type: Technical facts with architectural implications
Method: Agent can discover via filesystem inspection + reasoning
────────────────────────────────────────
Question Type: Directory listings
Method: Worthless - don't bother
What the Git Diff Represents
...
2. Determine: can I discover this? Or must I ask user?
3. If discoverable: investigate, reason, document WITH methodology
4. Update navigate-skogai skill with real knowledge
5. Skill becomes living reflection of verified understanding
