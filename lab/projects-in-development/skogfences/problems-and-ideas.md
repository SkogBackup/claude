...
2. is "can't see home" enough, or need "can't see anything outside workspace"?
3. how do you handle legitimate secrets the agent needs?
4. what's the recovery path when agent breaks something?
5. how do multiple humans share the same agent setup?
6. should agents be able to spawn subprocesses? (they currently do)
7. what about gui applications? clipboard? display?
