---
title: nelson-astute-provenance-audit
type: note
permalink: claude/personal/journal/2026-02-27/nelson-astute-provenance-audit
---
...
1. **Pattern preservation bias** (Netflix) — LLMs treating technical debt as requirements
1. **Premature victory declaration** (Anthropic harness) — agents declaring done too early
1. **Environment left in broken state** (Anthropic harness) — undocumented bugs between sessions
