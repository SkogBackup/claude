...
Reference full template: `/home/skogix/claude/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/skogix/claude/.claude/get-shit-done/templates/state.md`.
