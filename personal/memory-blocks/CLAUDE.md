...
title: CLAUDE
type: note
permalink: claude/personal/memory-blocks/claude
---

# personal/memory-blocks/ -- LORE Museum

Permanent historical record. These are archives, not active constraints. Load only when asked about specific eras or history.
